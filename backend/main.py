...
from backend.api.data_workspace import router as data_workspace_router
from backend.api._helpers import get_analytics_service
...
def data_summary():
    try:
        service = get_analytics_service().data_service
